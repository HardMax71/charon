    ...
    <div className="modal-overlay" onClick={handleClose}>
      <div className="modal-panel max-w-md" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header mb-4">
          <h3 className="text-lg font-semibold text-slate-900">Dependency Details</h3>
          <button
            onClick={handleClose}
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-3">
            ...
            <p className="font-semibold text-slate-900">{sourceNode?.label || selectedEdge.source}</p>
          </div>

          <div className="bg-green-50 border border-green-100 rounded-xl p-3">
            <p className="text-xs font-medium text-green-600 mb-1">To</p>
            <p className="font-semibold text-slate-900">{targetNode?.label || selectedEdge.target}</p>
          </div>

          <div>
            <p className="text-sm font-semibold text-slate-700 mb-2">
              Imported Names <span className="text-slate-600 font-normal">({selectedEdge.imports.length})</span>
            </p>
